...
import 'package:trackexpense/bar%20graph/bar_graph.dart';
...
// calculate max amount in bar graph
  double calculateMax(
    ...
    // get largest amount (which is at the end of the sorted list) and increase the cap slightly so the graph looks almost full
    max = values.last * 1.1;
